...
<body>
    ...
    <div class="main-wrapper">
        <section class="left_side_menu">
            ...
            <div class="left-menu-block authors-block">
                <h3>Автори</h3>
                <ul id="authors-list" class="menu-list"></ul>
            </div>
            <div class="left-menu-block authors-block">
                <h3>Нові користувачі</h3>
                <ul id="new-authors-list" class="menu-list"></ul>
            </div>
        </section>
